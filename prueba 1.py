...
class SistemaInventario:
    ...
    def cargar_datos(self):
        ...
        # 2. Disponibles - CORREGIDO: AGRUPACIÓN ESTRICTA
        for i in self.tabla_disp.get_children(): self.tabla_disp.delete(i)
        busq = f'%{self.ent_busqueda.get()}%'
        
        # Usamos MAX(articulo) para que traiga el nombre pero sume todo por el mismo código
        cursor.execute("""
